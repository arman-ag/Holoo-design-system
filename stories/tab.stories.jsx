        ...
        <div>
            <Tabs defaultValue="account" className="w-[800px]">
                ...
                <TabsContent value="account">
                    <div dir="rtl" style={{ minHeight: "200px", textAlign: "justifyContent" }} className=" flex items-center  bg-red-900 ">
                ...
                <TabsContent value="test">
                    <div dir="rtl" style={{ minHeight: "200px" }} className=" flex items-center  ">
